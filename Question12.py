...
age2=int(input("What is your age again\n"))
while age2!=user_age:
    if age2!=user_age:
        print(user_name, ", Put the same as the one earlier\n")
        age2=int(input("What is your age again\n"))
    else:
        break
...
print(user_name, ", now let's make a treasure calculator...\n")
print("Give the number of your gold coins and silver coins\n")
print("Note: the sum of your gold coins and silver coins should be \nequal to the previous number of coins you entered.\n\n")
gold_coin=int(input("Gold coins: "))
silver_coin=int(input("Silver coins: "))
total_coin=gold_coin+silver_coin
while total_coin!=coins:
    if total_coin!=coins:
        print(user_name,", read the Note above and put again the number of your coins:\n")
        gold_coin=int(input("Gold coins: "))
        silver_coin=int(input("Silver coins: "))
        total_coin=gold_coin+silver_coin
    else:
        break
if gold_coin>silver_coin:        
    difference_coin=gold_coin-silver_coin
else:
    difference_coin=silver_coin-gold_coin
product_coin= gold_coin*silver_coin
try:
    division_coin=gold_coin/silver_coin
except ZeroDivisionError:
    print(user_name,"you have",silver_coin, "silver coins.\nThe division cannot be done.")
else:
    print("Division: ",division_coin)    
print("Total coins= ", total_coin)
print("Difference of the coins= ", difference_coin)
print("Product of the coins= ", product_coin)
